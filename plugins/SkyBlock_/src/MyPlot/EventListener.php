    ...
    public function onPlayerMove(PlayerMoveEvent $event) {
        ...
        if ($plot !== null and $plot !== $this->plugin->getPlotByPosition($event->getFrom())) {
            ...
            if ($plot->owner != "") {
				...
				$event->getPlayer()->addTitle("§l§c♦ §bMine§aTown §c♦", "§a§lChào mừng bạn đến đảo của§e ".$owner);
				$this->plugin->getServer()->broadcastMessage("§l§c♦ §bMine§aTown §c♦ ".$event->getPlayer()->getName()."§b vừa đi sang đảo của §e".$owner);
            } else {
