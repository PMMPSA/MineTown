...
class PointAPI extends PluginBase implements Listener{
	...
	private function registerCommands(){
		...
		$commands = [
			"mypoint" => "\\onebone\\pointapi\\command\\MyMcoinCommand",
			"toppoint" => "\\onebone\\pointapi\\command\\TopMcoinCommand",
			"setpoint" => "\\onebone\\pointapi\\command\\SetMcoinCommand",
			"seepoint" => "\\onebone\\pointapi\\command\\SeeMcoinCommand",
			"givepoint" => "\\onebone\\pointapi\\command\\GiveMcoinCommand",
			"takepoint" => "\\onebone\\pointapi\\command\\TakeMcoinCommand",
			"payp" => "\\onebone\\pointapi\\command\\PayMcoinCommand",
			"setlangp" => "\\onebone\\pointapi\\command\\SetLangMCommand",
			"mystatusp" => "\\onebone\\pointapi\\command\\MyStatusMCommand"
		];
