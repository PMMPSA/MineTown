...
class PayMcoinCommand extends Command{
	private $plugin;

	public function __construct(PointAPI $plugin){
		$desc = $plugin->getCommandMessage("solomotooto2");
		parent::__construct("solomotooto2", $desc["description"], $desc["usage"]);

		$this->setPermission("pointapi.command.paymcoin");
