...
class TakeMcoinCommand extends Command{
	private $plugin;

	public function __construct(PointAPI $plugin){
		$desc = $plugin->getCommandMessage("solomotooto5");
		parent::__construct("solomotooto5", $desc["description"], $desc["usage"]);

		$this->setPermission("pointapi.command.takekc");
