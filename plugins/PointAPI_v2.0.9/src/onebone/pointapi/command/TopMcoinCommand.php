...
class TopMcoinCommand extends Command{
	/** @var PointAPI */
	private $plugin;

	public function __construct(PointAPI $plugin){
		$desc = $plugin->getCommandMessage("solomotooto6");
		parent::__construct("solomotooto6", $desc["description"], $desc["usage"]);

		$this->setPermission("pointapi.command.topkc");
