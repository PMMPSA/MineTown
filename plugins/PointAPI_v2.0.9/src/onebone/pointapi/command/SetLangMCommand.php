...
class SetLangMCommand extends Command{
	private $plugin;

	public function __construct(PointAPI $plugin){
		$desc = $plugin->getCommandMessage("setlangkc");
		parent::__construct("setlangkc", $desc["description"], $desc["usage"]);

		$this->setPermission("pointapi.command.setlangkc");
