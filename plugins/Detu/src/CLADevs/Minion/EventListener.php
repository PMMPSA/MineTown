            ...
            if(--$this->seconds === 0){
                ...
                Main::get()->getScheduler()->cancelTask($this->time->getTaskId());
                        ...
                        case Item::EMERALD:
                            ...
                            if(RebirthCoinAPI::getInstance()->myRebirthCoin($player) < $entity->getCost()){
                                $player->sendMessage(C::RED . "§l§c♥ §aĐệ Tử§b → Bạn Không Đủ Rebirth Coin Để Nâng Cấp");
                                return;
                            }
                            ...
                            RebirthCoinAPI::getInstance()->reduceRebirthCoin($player, $entity->getCost());
                            break;
                            case Item::ANVIL:
                            ...
                            if(RebirthCoinAPI::getInstance()->myRebirthCoin($player) <= 1499){
                                $player->sendMessage(C::RED . "§l§c♥ §aĐệ Tử§b → Bạn Không Đủ Rebirth Coin Để Mua");
                                $inv->onClose($player);
                                return;
                            }
                            $entity->namedtag->setString("autofix", "yes");
                            $player->sendMessage(C::GREEN . "§l§c♥ §aĐệ Tử§b → Bạn Đã Mua AutoFix Thành Công");
                            RebirthCoinAPI::getInstance()->reduceRebirthCoin($player, 1499);
                            break;
                            ...
                            if(RebirthCoinAPI::getInstance()->myRebirthCoin($player) <= 9499){
                                $player->sendMessage(C::RED . "§l§c♥ §aĐệ Tử§b → Bạn Không Đủ Rebirth Coin Để Mua");
                                $inv->onClose($player);
                                return;
                            }
                            ...
                            RebirthCoinAPI::getInstance()->reduceRebirthCoin($player, 9499);
                            break;
                    }
                    $inv->onClose($player);
                }
