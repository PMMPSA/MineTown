...
class HopperInventory extends CustomInventory{
    ...
    public function getDestoryItem(): Item{
        ...
        $item->setCustomName(C::RED . "Bế Đệ Tử Lên");
        return $item;
    }
    ...
    public function getLevelItem(): Item{
        ...
        $item->setCustomName(C::LIGHT_PURPLE . "Cấp Độ: " . C::YELLOW . $this->entity->getLevelM());
        $item->setLore([C::LIGHT_PURPLE . "Giá: " . C::YELLOW . "$" . $this->entity->getCost()]);
        return $item;
    }
    public function getAutoFixItem(): Item{
        ...
        if($this->entity->getAutoFix() === "no"){
                $item->setLore(["§9Bạn Chưa Mua.\n".C::LIGHT_PURPLE . "§l§fGiá: §r§f" . C::YELLOW . "$ 1499"]);
        }else{
    ...
    public function getEterItem(): Item{
        ...
        $item->setLore(["§9Bạn Chưa Mua.\n".C::LIGHT_PURPLE . "§l§fGiá: §r§f" . C::YELLOW . "$ 9499"]);
        }else{
        $item->setLore(["§cBạn Đã Mua."]);
        }
        return $item;
